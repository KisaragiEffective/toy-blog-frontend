(function() {
	const TIPS = [
		'なぜ私は2020年にもなってテーブルレイアウトをしていますか？',
		'ハンガリアン記法を思い出して吐きそうになった',
		'Stringly Typed',
		'6年ゴミスペをリースするとかいう恐ろしい話を聞いてしまった',
		'非同期なんもわからん',
		'またコンテナぶっ壊してしまった',
		'無限ループを使うと検察に訴えられるので末尾再帰しよう',
		'READY PLAYER 1',
		'Re:0から始めるリファクタリング with SeichiAssist',
		'ささやかな地雷をありがとう;;',
		'[main/WARN] わーん！！！！！！！！！！',
		'そう、カナダのCに、パリのP。そして、サボタージュのSに変換でCPS変換',
		'今日もSafariがカス！！！！！！！！！！！！！！',
	];
